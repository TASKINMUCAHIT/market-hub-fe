...
var I = class _I extends HTMLElement {
  ...
  createElements() {
    if (this._root = this.attachShadow({ mode: "open" }), _) E || (E = new CSSStyleSheet(), E.replaceSync(v)), this._root.adoptedStyleSheets = [E];
    else {
...
var w = class {
  ...
  connect() {
    ...
    this._lottie = this._animationLoader(__spreadProps(__spreadValues(__spreadValues({}, this._options), i2), { container: this._container, animationData: Object.assign(e(this._iconData), t2) })), this._initial.colors && (this.colors = this._initial.colors), this._initial.stroke && (this.stroke = this._initial.stroke), this._lottie.addEventListener("complete", ((e2) => {
